...
# ============================================================
# 📘 LIVRO (AQUI VOCÊ VAI COLOCANDO AS IMAGENS DO LIVRO)
# ============================================================
def render_livro():
    st.title("📘 Eu Já Existia Antes de Você")
    st.markdown("*Um caminho de volta para si*")
    ...
    st.markdown("---")
    st.subheader("📌 Páginas do livro")

    # ✅ aqui você vai só adicionando as páginas (imagens) em ordem
    # EXEMPLOS (você pode apagar ou manter):
    # st.image("assets/01_pagina_1.png", use_container_width=True)
    # st.image("assets/02_pagina_2.png", use_container_width=True)
    # st.image("assets/03_pagina_3.png", use_container_width=True)

    st.info("Quando você me mandar as páginas, eu vou encaixando aqui (uma por uma) certinho, sem quebrar o app.")
